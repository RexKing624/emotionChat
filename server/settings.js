...
export const defaults = { language: 'zh', name: 'Assistant', minMinutes: 10, maxMinutes: 30, quietStart: '23:00', quietEnd: '09:00' };
export function validateSettings(value) {
  ...
  return { language, name: value.name.trim(), minMinutes: value.minMinutes, maxMinutes: value.maxMinutes, quietStart: value.quietStart, quietEnd: value.quietEnd };
}
